...
/// Card produit pour la page Favoris.
///
/// Design identique à HomeProductCard mais avec :
/// - Cœur toujours rempli (rouge) → tap retire le favori
/// - Animation de suppression douce
/// - Même carousel, prix vert, bouton "Ajouter au panier"
...
class _FavoriteProductCardState extends State<FavoriteProductCard>
  ...
  /// Carousel d'images avec indicateurs et bouton favori (rempli).
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          // Bouton favori (toujours rempli, tap → retirer)
          Positioned(
            top: 16,
            right: 16,
            child: GestureDetector(
              onTap: () {
                context.read<FavoritesBloc>().add(
                  FavoritesRemoveRequested(widget.product.id),
                );
              },
              child: Container(
                width: 40,
